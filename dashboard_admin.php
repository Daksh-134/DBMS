...
<body>
    <div class="header-div">
        ...
        <center>
            <nav class="menu">
                ...
                <a href="add_enrollment.html">Add Enrollment</a>
                <a href="add_schedule.html">Add Schedule</a>
                <a href="update_schedule.html">Update Schedule</a>
                <a href="delete_student.html">Remove Student</a>
                <a href="delete_faculty.html">Remove Faculty</a>
            </nav>
    ...
    <div class="container">
        <div class="Homepage-img">
            <div class="h1">
            <h2> You can access any information regarding courses , schedule,faculty ,students .</h2>
            </div>
    </div>
</body>
